...
public class GetElementUITool {
    static String fileP = "D:\\Download\\element-ui\\";
    ...
    static void GetFile(String url) throws Exception{
        ...
        if(http.getResponseCode() == 200) {
            ...
            if (!f.exists()){
                f.createNewFile(); FileOutputStream fos = new FileOutputStream(f, false);
                fos.write(all);
                fos.flush();
                fos.close();
            }
